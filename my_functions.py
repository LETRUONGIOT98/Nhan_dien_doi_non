...
conf_set=0.2  #độ nhạy nhận dạng
frame_size=(800, 480) 
head_classification_threshold= 0.2 # độ nhạy đội nón bảo hiểm
...
def object_detection(frame):
	...
	pred = non_max_suppression(pred, conf_set, 0.3) # prediction, conf, iou
